...
mountain_stance:setParameter(CONDITION_PARAM_STAT_MAXHITPOINTSPERCENT, 125)
...
player:attachEffectById(217, true)
	 -------------------------------- ID IMAGE, SECONDS, TEXT, BACKGROUND
    player:sendAddBuffNotification(18, duration / 1000, 'Reduce Damage taken by 30% and increases your max health by 25%.', 3, 0)
end
    return true
end
