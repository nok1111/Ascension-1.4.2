...
combatNorth:setParameter(COMBAT_PARAM_TYPE, COMBAT_ICEDAMAGE)
...
combatEast:setParameter(COMBAT_PARAM_TYPE, COMBAT_ICEDAMAGE)
...
combatWest:setParameter(COMBAT_PARAM_TYPE, COMBAT_ICEDAMAGE)
...
function onCastSpell(creatureId, variant, target)
    ...
    local iceOrbs = getActiveOrbs(creatureId, "ice")
    if iceOrbs < 2 then
        doPlayerSendCancel(creatureId, "You need 2 ice orbs to use Fists of Ice.")
        return false
    end
