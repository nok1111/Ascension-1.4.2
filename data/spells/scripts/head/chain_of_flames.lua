local config = {
    ...
    effect = 480,
    damageEffect = 480, -- Damage effect
    chainEffect = 76, -- Chain effect
    element = COMBAT_FIREDAMAGE, -- Damage type
...
function onCastSpell(creature, variant, isHotkey)
    ...
    if not boots or boots:getId() ~= 38158 then
        player:sendCancelMessage("You must equip the Chain of Flames spell to use this effect.")
        return false
    end
