local SPELL_NAME = "Death Wave"
local MIN_WAVE_DAMAGE = 200 
local MAX_WAVE_DAMAGE = 220 
local PUSH_DISTANCE = 1 
local WAVE_WIDTH = 10 
local WAVE_LENGTH = 20  -- 6 behind + 8 ahead
local WAVE_EFFECT = 799 
...
stun:setParameter(CONDITION_PARAM_TICKS, 6000)
...
function onCastSpell(caster, variant)
    ...
    caster:attachEffectById(158, true)
    caster:addCondition(stun)
