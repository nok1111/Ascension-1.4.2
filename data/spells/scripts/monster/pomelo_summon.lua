...
local experiment_pos = {   
	Position(4148, 4072, 6), -- position of energy wall
	Position(4166, 4072, 6), -- position of energy wall
...
return false
	...
	creature:getPosition():sendMagicEffect(CONST_ME_FIREATTACK)
		...
		Game.createMonster("putrid experiment", Position(4149, 4072, 6), true, true) --left
		Game.createMonster("putrid experiment", Position(4165, 4072, 6), true, true) --right
