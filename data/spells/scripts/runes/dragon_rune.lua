local config = {
	...
	bleed_runeingTicks = 4,	--So i can configure the healing more easily
	TimeBetweenTicks = 750 --Same ^
}
...
function onTargetCreature(creature, target)
	...
	local damage = (magic * 3.5) + (targetmaxhp * 2.2) + 15
	--End formula

	local bleed_rune = Condition(CONDITION_FIRE)
