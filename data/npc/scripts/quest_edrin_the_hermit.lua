...
function greetCallback(cid)
    doSendDialogNpc(cid, getNpcCid(), "Hmph... young ones always running around, never stopping to notice the trees. \nI used to gather elderwood myself, but these hands-bah! Too weak now. You, though... you\'ve got strength in you. \n\nMaybe you\'d be willing to help an old man?", "quests&rewards&close")
    return true             
end
