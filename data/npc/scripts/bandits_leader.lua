...
function creatureSayCallback(cid, type, msg)
  ...
  updateStateTaskListByNpcName("Sheriff Gordon", player)
     local taskList = getTaskListByNpcName("Sheriff Gordon", player)
    local completeTask = getCompleteForPrizeTaskList("Sheriff Gordon", player)
