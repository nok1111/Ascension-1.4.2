local requiredStorage = 50001 -- Storage ID for passage
...
function greetCallback(cid)
    ...
    if storageValue < 1 then
        -- Player does not have the required storage
        doSendDialogNpc(cid, getNpcCid(), "Only those who have embraced the chill of the grave may walk beyond this threshold... You are not yet marked by the veil.", "close")
    else
...
function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msg:lower(), "pass") then
