...
function greetCallback(cid)
    doSendDialogNpc(cid, getNpcCid(), "Ah, traveler! We dwarves have suffered a great theft. The goblins stole the Runestone of Ankor! Venture into the mines and reclaim it for us!", "quests&rewards&close")
    return true             
end
...
function creatureSayCallback(cid, type, msg)
    ...
    -- Required Quest Giver Code Block
