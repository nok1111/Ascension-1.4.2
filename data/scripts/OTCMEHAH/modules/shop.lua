...
function init()
    ...
    ----------------------- ITENS
    -----------------------------------------------------------------------------
    category1.addItem(2000, 3967, 1, "30 Days Premium Card", "30 Days Premium Card")
    category1.addItem(1000, 7314, 1, "10 Days Premium Card", "10 Days Premium Card")
    category1.addItem(1200, 7499, 1, "1000 premium points scroll", "Scroll of 1000 premium points.")
    category1.addItem(3600, 7500, 1, "3000 premium points scroll", "Scroll of 3000 premium points.")
    -- category1.addItem(250, 7550, 1, "Exp Boost", "Exp boost item. It will give you 20% more exp from monsters for 2 hours.")
    category1.addItem(1500, 7544, 1, "Glove Loss Box", "one glove item loss.")
    category1.addItem(1500, 7545, 1, "Ki Loss Box", "one ki attack item loss")
    category1.addItem(1500, 7546, 1, "Sword Loss Box", "one sword item loss")
    category1.addItem(500, 7542, 1, "Ultimate Capsule", "capsule with 36 slots and 1 weight.")
    category1.addItem(1800, 6433, 1, "Frag Remover", "This item will remove all your frags and skulls.")
    category1.addItem(250, 7591, 1, "Super Equipement Enchant",
        "With that item you have more chance to put enchant on item")
    category1.addItem(250, 7590, 1, "Super Weapon Enchant", "With that item you have more chance to put enchant on item")
    category1.addItem(1500, 2209, 1, "saiyan ring", "ki regeneration +300/s")
...
function processBuy(player, data)
    ...
    if status == true then
        db.query("UPDATE `accounts` set `premium_points` = `premium_points` - " .. offer['cost'] .. " WHERE `id` = " ..
                     player:getAccountId())
        db.asyncQuery(
            "INSERT INTO `shop_history` (`account`, `player`, `date`, `title`, `cost`, `details`) VALUES ('" ..
                player:getAccountId() .. "', '" .. player:getGuid() .. "', NOW(), " .. db.escapeString(offer['title']) ..
...
local creatureEvent = CreatureEvent("shopModule")
