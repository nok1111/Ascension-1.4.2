...
{
	Database& db = Database::getInstance();
	return loadPlayer(player, db.storeQuery(fmt::format("SELECT `id`, `name`, `account_id`, `group_id`, `sex`, `vocation`, `experience`, `level`, `maglevel`, `health`, `healthmax`, `blessings`, `mana`, `manamax`, `manaspent`, `soul`, `lookbody`, `lookfeet`, `lookhead`, `looklegs`, `looktype`, `lookaddons`, `currentwing`, `randomizewing`,`currenteffect`, `randomizeeffect`,`currentaura`, `randomizeaura`,`currentshader`, `randomizeshader`,`posx`, `posy`, `posz`, `cap`, `lastlogin`, `lastlogout`, `lastip`, `conditions`, `skulltime`, `skull`, `town_id`, `balance`, `offlinetraining_time`, `offlinetraining_skill`, `stamina`, `skill_fist`, `skill_fist_tries`, `skill_club`, `skill_club_tries`, `skill_sword`, `skill_sword_tries`, `skill_axe`, `skill_axe_tries`, `skill_dist`, `skill_dist_tries`, `skill_shielding`, `skill_shielding_tries`, `skill_fishing`, `skill_fishing_tries`, `direction`, `stat_str`, `stat_int`, `stat_dex`, `stat_vit`, `stat_spr`, `stat_wis`, `stat_luck`, `stat_res`, `stat_com`, `stat_vor` FROM `players` WHERE `id` = {:d}", id)));
}
...
bool IOLoginData::loadPlayer(Player* player, DBResult_ptr result)
{
	...
	static const std::string charStatNames[] = {"stat_str", "stat_int", "stat_dex", "stat_vit", "stat_spr", "stat_wis", "stat_luck", "stat_res", "stat_com", "stat_vor"};
...
bool IOLoginData::savePlayer(Player* player)
{
	...
	query << "`stat_luck` = " << static_cast<uint16_t>(player->charStats[CHARSTAT_LUCK]) << ',';
