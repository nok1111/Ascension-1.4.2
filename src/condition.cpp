...
bool ConditionAttributes::setParam(ConditionParam_t param, int32_t value)
{
	...
	switch (param) {
		...
		case CONDITION_PARAM_SKILL_BLACKSMITH: {
			skills[SKILL_BLACKSMITH] = value;
			return true;
		}
		case CONDITION_PARAM_SKILL_BLACKSMITHPERCENT: {
			skillsPercent[SKILL_BLACKSMITH] = value;
			return true;
		}
		...
		case CONDITION_PARAM_SKILL_HERBALISMPERCENT: {
			skillsPercent[SKILL_HERBALISM] = value;
			return true;
		}


		case CONDITION_PARAM_SKILL_RUNESEEKER: {
			skills[SKILL_RUNE_SEEKER] = value;
			return true;
		}

		case CONDITION_PARAM_SKILL_RUNESEEKERPERCENT: {
			skillsPercent[SKILL_RUNE_SEEKER] = value;
			return true;
		}
