...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(CONDITION_PARAM_SKILL_FISHING)
		...
		registerEnum(CONDITION_PARAM_SKILL_BLACKSMITH)
		registerEnum(CONDITION_PARAM_SKILL_BLACKSMITHPERCENT)

		registerEnum(CONDITION_PARAM_SKILL_ALCHEMY)
		registerEnum(CONDITION_PARAM_SKILL_ALCHEMYPERCENT)

		registerEnum(CONDITION_PARAM_SKILL_COOKING)
		registerEnum(CONDITION_PARAM_SKILL_COOKINGPERCENT)
		...
		registerEnum(CONDITION_PARAM_SKILL_HERBALISMPERCENT)

		registerEnum(CONDITION_PARAM_SKILL_RUNESEEKER)
		registerEnum(CONDITION_PARAM_SKILL_RUNESEEKERPERCENT)
	...
	registerEnum(SKILL_RUNE_SEEKER)
