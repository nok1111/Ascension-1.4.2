...
enum ConditionParam_t {
	...
	CONDITION_PARAM_SPECIALSKILL_ATTACKSPEED = 56,
	CONDITION_PARAM_SPECIALSKILL_WEAKEN = 57,
	CONDITION_PARAM_SPECIALSKILL_EXTRAHEALING = 58,
};
...
enum SpecialSkills_t {
	...
	SPECIALSKILL_WEAKEN,
	SPECIALSKILL_EXTRAHEALING,

	SPECIALSKILL_FIRST = SPECIALSKILL_CRITICALHITCHANCE,
	SPECIALSKILL_LAST = SPECIALSKILL_EXTRAHEALING
};
...
enum CharacterStats_t
{
	...
	CHARSTAT_WISDOM,
	CHARSTAT_LUCK,        // 6
	CHARSTAT_RESILIENCE,  // 7
	CHARSTAT_COMPASSION,  // 8
	CHARSTAT_VORACITY,    // 9

	CHARSTAT_FIRST = CHARSTAT_STRENGTH,
	CHARSTAT_LAST = CHARSTAT_VORACITY
};
